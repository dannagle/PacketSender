...
void TcpThread_QApplicationNeeded_tests::testPrepareForPersistentLoop_preparesSendPacketCorrectly()
{
...
void TcpThread_QApplicationNeeded_tests::testPrepareForPersistentLoop_setsUpClientConnection()
{
    QTcpServer server;
    QVERIFY(server.listen(QHostAddress::LocalHost, 0));
    quint16 serverPort = server.serverPort();
...
void TcpThread_QApplicationNeeded_tests::testPrepareForPersistentLoop_withRealSocket_updatesPorts()
{
    QTcpServer server;
    QVERIFY(server.listen(QHostAddress::LocalHost, 0));
    quint16 serverPort = server.serverPort();
