...
copy /Y packetsender.exe D:\github\naglecode-installers\packetsenderinstaller\q5_15_2_mingw64\packetsender.exe
...
C:\Qt\5.15.2\mingw81_64\bin\qmake.exe -o Makefile src/PacketSenderCLI.pro -spec win32-g++
C:\Qt\Tools\mingw810_64\bin\mingw32-make.exe -f Makefile.Release
...
copy /Y packetsendercli.exe D:\github\naglecode-installers\packetsenderinstaller\q5_15_2_mingw64\packetsender.com
