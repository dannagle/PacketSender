...
# "/Users/dannagle/Qt/6.5.3/macos/bin/qmake" PacketSender.pro -spec macx-clang CONFIG+=qtquickcompiler
"/Users/dannagle/Qt/6.5.3/macos/bin/qmake" PacketSender.pro -spec macx-clang CONFIG+=qtquickcompiler QMAKE_APPLE_DEVICE_ARCHS="x86_64 arm64"

# /Users/dannagle/Qt/6.5.3/macos/bin/qmake /Users/dannagle/github/PacketSender/src/PacketSender.pro -spec macx-clang CONFIG+=qtquickcompiler QMAKE_APPLE_DEVICE_ARCHS="x86_64 arm64" && /usr/bin/make qmake_all

make 
# /Users/dannagle/Qt/6.5.3/macos/bin/macdeployqt packetsender.app -appstore-compliant
/Users/dannagle/Qt/6.5.3/macos/bin/macdeployqt packetsender.app -appstore-compliant
