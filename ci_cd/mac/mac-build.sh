...
"/Users/dannagle/Qt/6.4.1/clang_64/bin/qmake" PacketSender.pro -spec macx-clang CONFIG+=x86_64
make
/Users/dannagle/Qt/6.4.1/clang_64/bin/macdeployqt packetsender.app -appstore-compliant
